            ...
            controller: ['$scope', '$http', '$mdDialog', function controller($scope, $http, $mdDialog) {
                ...
                $http({
                    ...
                    if (response.data != undefined) {
                        ...
                        if (response.data.REPORTPB != "") {
                            console.log(response.data.REPORTPB);
                            $scope.avail_reportpb = false;
                            $scope.returnMessageService = response.data.REPORTPB;
                        } else {
                            $scope.avail_reportpb = true;
                            $scope.returnMessageService = "";
                        }
                    } else {
                        $scope.returnMessageService = "Le services est temporairement hors-service, veuillez réessayer ultérieurement.";
                    }
                }, function(response) {
                    $scope.returnMessageService = "Le services est temporairement hors-service, veuillez réessayer ultérieurement.";
                });
